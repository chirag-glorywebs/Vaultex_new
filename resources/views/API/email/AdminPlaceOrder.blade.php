    ...
    <div class="mail-inner-content">
        ...
        <div class="mail-body">
            <div class="body-title">
                ...
                <p><strong>you have received an order
                        from {{$user_info[0]['first_name']}} {{$user_info[0]['last_name']}} .</strong><br/></p>
                <p><strong>The order is as follows :- </strong></p>
                                        ...
                                        @foreach($cart_data as $data)
                                            <tr>
                                                <td class="table-td" style="text-align:center;width: 30%;">
                                                    <div class="title"><img src="{{asset($data->main_image)}}"
                                                                            alt="vaultex" height="50"/></div>
                                                </td>
                                                <td class="table-td" style="text-align:center;width: 30%;">
                ...
                <div style="width:70%; float: left; height:100px;">
                    <strong>Discount [just in case]</strong>
                    : @if(!empty($order->coupon_amount)){{$order->coupon_amount}} {{$currancy->value}}@endif<br/>
                ...
                <div style="width:30%; float:right; height:100px;">
                    <strong style="text-align: right;">Billing Address</strong><br/>
                    {{$user_info[0]['address']}}
                </div>
                <pre>
                ...
                <div class="order-summary">
                            ...
                            <tr>
                                <td colspan="2">
                                    <table cellspacing="0" cellpadding="0" border="0">
                                        <tbody>
                                        <tr>
                                            <div class="title"><p style="text-align: left;"><strong> Payment Method :
                                                        Cash On Delivery</div>
                                            <div class="title"><p style="text-align: left;"><strong> Delivery Details :
                                                        Standered Delivery</div>
                                            <div class="title"><p style="text-align: left;"><strong> Customer's Details
                                                        : {{$user_info[0]['email']}}</div>
                    ...
                    <div class="mail-footer">
                        <p><b>Copyright © <?php echo date("Y"); ?> SBM. All right reserved. </b></p>
                    </div>
                </div>
</body>
</html>
