        ...
        <div class="mail-inner-content">
            ...
            <div class="mail-body">
                <div class="body-title">
                    ...
                    <p>"{{ $cart->product->product_name ?? '-' }} - {{ $cart->product->sku ?? '-' }}" product quantity update from {{ $fromQuantity }} to {{ $quantity }} from
                        {{ $cart->user->name ?? '-' }}'s cart beacuse of insufficient quantity in stock.</p>
                    <p>Thank You</p>
                </div>
            </div>
            <!-- FOOTER -->
