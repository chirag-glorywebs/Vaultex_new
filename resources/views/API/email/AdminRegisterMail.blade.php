...
<div class="mail-container">
    <div class="mail-inner-content">
        ...
        <div class="mail-body">
            ...
            </span>Admin<br/><span> </span>
                </h4>
                <p><strong>New User {{$Admin['name']}} is Register Successfull in to Vaultex.</strong></p><br/>
                <p><strong></strong></p>
                <br/>
                <br/>
                <br/>
        ...
        <div class="mail-footer">
            <p><br/>
                <b>Copyright © <?php echo date("Y"); ?> SBM. All right reserved.</b></p>
        </div>
    </div>
</div>
</body>
